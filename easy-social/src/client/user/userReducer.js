...
export default function userReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case actions.GET_FOLLOWING_SUCCESS:
      // console.log("REDUCER GET_FOLLOWING_SUCCESS payload: ",action.payload);
      const filteredRecommendations = filterRecommendations(action.payload);
      // console.log("REDUCER GET_FOLLOWING_SUCCESS filterRecommendations: ",filteredRecommendations);
