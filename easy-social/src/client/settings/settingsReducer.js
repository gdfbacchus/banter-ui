...
const settings = (state = initialState, action) => {
  switch (action.type) {
    ...
    case ACTION_TYPES.START_SAVE_SETTINGS:
      return {
        ...state,
        savingProfileSettings: true
      };
    case ACTION_TYPES.RESET_PROFILE_SETTINGS_STATUS:
      return {
        ...state,
        profileSaveSettingsStatus: '',
        savingProfileSettings: false
      };
    case ACTION_TYPES.SAVING_PROFILE_SETTINGS_COMPLETED:
      return {
        ...state,
        profileSaveSettingsStatus: action.payload.status,
        savingProfileSettings: false
      };
    default:
      return state;
...
export const getProfileSaveStatus = state => state.profileSaveSettingsStatus;
export const getSavingProfileSettings = state => state.savingProfileSettings;
