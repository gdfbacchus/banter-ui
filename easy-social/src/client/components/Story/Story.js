...
class Story extends React.Component {
  ...
  componentDidMount() {
    ...
    // console.log("IS MOUNTED 1: ",this._isMounted_)
    ...
    getAccount(author).then((resp)=>{
      ...
      if (!this._isMounted_){
        // console.log("IS this 2: ",this)
        // console.log("IS MOUNTED 2: ",this._isMounted_);
        return;
      }
      ...
      <div className="Story" id={`${post.author}-${post.permlink}`}>
        ...
        <div className="Story__content">
          <div className="Story__header">
            <Link to={`/@${post.author}`}>
              <Avatar username={post.author} size={40} profileImage={this.state.profileImage} />
