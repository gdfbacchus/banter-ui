...
class Comment extends React.Component {
  ...
  redirectAfterSuccess() {
    // return <Redirect to={`/@${user.name}/${this.props.parent.root_permlink}`}/>
    return <Redirect to={`/@${this.props.parent.author}/${this.props.parent.root_permlink}`}/>
  }
  ...
  render() {
    ...
    // console.log("Comment saving status: ", status);
    // console.log("CommentForm this.props.parent: ", this.props.parent);
    // if(status==='success') {
    ...
    return (
      <div ref={this.setSelf} className="Comment" id={anchorId}>
        ...
        <Link to={`/@${comment.author}`} style={{ height: avatarSize }}>
          <Avatar username={comment.author} size={avatarSize} profileImage={this.state.profileImage} />
