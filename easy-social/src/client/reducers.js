...
import registerReducer, * as fromRegister from './account/registrationReducer';
...
export const getIsAvailableAccount = state => fromRegister.getIsAvailableAccount(state.register);
export const getIsAvailablePassword = state => fromRegister.getIsAvailablePassword(state.register);
export const getIsProcessing = state => fromRegister.getIsProcessing(state.register);
export const getRegStatus = state => fromRegister.getRegStatus(state.register);
...
export const getStausSendingPostOrComment = (state) => fromPosts.getStausSendingPostOrComment(state.posts);
...
export const getProfileSaveStatus = state => fromSettings.getProfileSaveStatus(state.settings);
export const getSavingProfileSettings = state => fromSettings.getSavingProfileSettings(state.settings);
